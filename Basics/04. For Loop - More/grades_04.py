...
betw_four_five = betw_four_five / students_count * 100
betw_three_four = betw_three_four / students_count * 100
fail_stud = fail_stud / students_count * 100

print(f'Top students: {top_stud:.2f}%')
print(f'Between 4.00 and 4.99: {betw_four_five:.2f}%')
print(f'Between 3.00 and 3.99: {betw_three_four:.2f}%')
